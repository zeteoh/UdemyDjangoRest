...
class StreamPlatformTestCase(APITestCase):
    ...
    def test_streamplatform_ind(self):
        """Passing in the individual id of the stream platform
        """
    ...
    #     self.client.post(reverse('streamplatform-list'), data)
...
class ReviewTestCase(APITestCase):
    ...
    """working with a particular URL, specify the full path
    """
